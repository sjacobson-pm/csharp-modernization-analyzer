...
public sealed class SarifGenerator
{
    ...
    {
        return results
            .GroupBy(result => new { result.RuleId, result.RuleName, result.Description })
                    ...
                    new
                    {
                        physicalLocation = new
                        {
                            ...
                            region = new
                            {
                                ...
                                endColumn = Math.Max(result.LineSpan.End.Character + 1, result.LineSpan.Start.Character + 1)
                            }
                        }
                    }
                },
